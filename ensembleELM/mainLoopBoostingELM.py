...
for i in range(20):
	...
	YtsList, alphaList, TtsMax, trainingTime = boostingELM(Xtr, Xts, Ttr, Tts, models)

	trainingTimeList.append(trainingTime)

	metrics, votedacc, votedrecal, votedprec = majorityVotingBoosting(YtsList, alphaList, TtsMax)
...
# save metrics
votedmetrics.to_csv("boostingELM_voted_metrics_{}_model.csv".format(models), index=False)
